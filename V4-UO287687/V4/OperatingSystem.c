...
int numberOfPartitions=0; //V4 Ejercicio 5 b
...
void OperatingSystem_RestoreContext(int PID) {
	...
	MMU_SetBase(partitionsTable[processTable[PID].partition].initAddress);//V4-Ejercicio6
...
void OperatingSystem_HandleException() {
	...
	case INVALIDINSTRUCTION:
		ComputerSystem_DebugMessage(140,INTERRUPT,executingProcessID,programList[processTable[executingProcessID].programListIndex]->executableName,"invalid instruction"); //V4 - Ejercicio 2 b
		break;
	default:
