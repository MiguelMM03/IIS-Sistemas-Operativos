...
int registerC_CPU; //EJ7d V2
int registerD_CPU;//EJ7d V2
...
void Processor_DecodeAndExecuteInstruction() {
	...
	switch (operationCode) {
		...
		case TRAP_INST: 
			...
			//registerB_CPU=operand2; 
			registerC_CPU=operand1; //EJ 7 V2
			registerD_CPU=operand2; //EJ 7 V2
			registerPC_CPU++;
			break;
		...
		case RET_INST: // Return from a subroutine
			registerPC_CPU=Processor_CopyFromSystemStack(registerSP_CPU++);
			break;		
...
// Getter for the RegisterC //Ej7 V2
int Processor_GetRegisterC() {
  return registerC_CPU;
}

// Setter for the RegisterC //Ej7 V2
void Processor_SetRegisterC(int reg){
  registerC_CPU= reg;
}

// Getter for the RegisterD //Ej7 V2
int Processor_GetRegisterD() {
  return registerD_CPU;
}

// Setter for the RegisterD //Ej7 V2
